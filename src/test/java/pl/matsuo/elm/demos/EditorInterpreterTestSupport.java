...
class EditorInterpreterTestSupport {
  ...
  private static final String[] MODULE_PATHS = {
    ...
    "projects/elm-editor/src/EvalRandom.elm",
    "projects/elm-editor/src/EvalTime.elm",
    "projects/elm-editor/src/EvalHttp.elm",
    "projects/elm-editor/src/EvalFile.elm",
    "projects/elm-editor/src/EvalTask.elm",
    "projects/elm-editor/src/EvalBrowser.elm",
    "projects/elm-editor/src/EvalEncode.elm",
