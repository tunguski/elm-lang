...
var $rt = {
  ...
  'Dict.foldl': function(f){ return function(acc){ return function(d){ d.a.forEach(function(e){ acc=A3(f,e[0],e[1],acc); }); return acc; }; }; },
  'Dict.foldr': function(f){ return function(acc){ return function(d){ for(var i=d.a.length-1;i>=0;i--){ acc=A3(f,d.a[i][0],d.a[i][1],acc); } return acc; }; }; },
  'Dict.foldr': function(f){ return function(acc){ return function(d){ for(var i=d.a.length-1;i>=0;i--) acc=A3(f,d.a[i][0],d.a[i][1],acc); return acc; }; }; },
  ...
  'Set.foldl': function(f){ return function(acc){ return function(s){ s.a.forEach(function(x){ acc=A2(f,x,acc); }); return acc; }; }; },
  'Set.foldr': function(f){ return function(acc){ return function(s){ for(var i=s.a.length-1;i>=0;i--){ acc=A2(f,s.a[i],acc); } return acc; }; }; },
  'Set.foldr': function(f){ return function(acc){ return function(s){ for(var i=s.a.length-1;i>=0;i--) acc=A2(f,s.a[i],acc); return acc; }; }; },
  ...
  'Array.foldl': function(f){ return function(acc){ return function(arr){ arr.a.forEach(function(x){ acc=A2(f,x,acc); }); return acc; }; }; },
  'Array.foldr': function(f){ return function(acc){ return function(arr){ for(var i=arr.a.length-1;i>=0;i--) acc=A2(f,arr.a[i],acc); return acc; }; }; },
  ...
  'List.foldl': function(f){ return function(acc){ return function(xs){ while(xs.$==='::'){ acc=A2(f,xs.a,acc); xs=xs.b; } return acc; }; }; },
  'List.foldr': function(f){ return function(acc){ return function(xs){ var a=$listToArray(xs); for(var i=a.length-1;i>=0;i--) acc=A2(f,a[i],acc); return acc; }; }; },
  ...
  'String.foldl': function(f){ return function(acc){ return function(s){ Array.from(s).forEach(function(ch){ acc=A2(f,$char(ch.codePointAt(0)),acc); }); return acc; }; }; },
  'String.foldr': function(f){ return function(acc){ return function(s){ var a=Array.from(s); for(var i=a.length-1;i>=0;i--){ acc=A2(f,$char(a[i].codePointAt(0)),acc); } return acc; }; }; },
